        ...
        <View className="flex-1 justify-end bg-black/60">
            ...
            <View className="h-2/3 rounded-t-3xl bg-white p-6 dark:bg-[#252525]">
                <View className="mb-4 flex-row items-center justify-between">
                    <Text className="font-visby-bold text-xl text-gray-900 dark:text-white">Add to Collection</Text>
                ...
                <ScrollView className="flex-1 mb-4">
                        ...
                        {availableCollections.map(name => {
                            ...
                            >
                                <View className="flex-row items-center">
                                    ...
                                    <Text className="font-visby-bold text-base text-gray-800 dark:text-gray-200">{name}</Text>
                                </View>
                                {isSelected && (
                        ...
                        {availableCollections.length === 0 && (
                            <View className="py-8 items-center">
                                <Text className="text-gray-400 font-visby text-center">No collections yet. Create one!</Text>
                            </View>
                        )}
                </ScrollView>
                ...
                <View>
                    <Text className="mb-2 font-visby-bold text-sm text-gray-500">Create New Collection</Text>
                    <View className="flex-row gap-2">
                        ...
                        >
                            <Ionicons name="add" size={24} color={newCollectionName.trim() ? (isDark ? "black" : "white") : "#888"} />
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
