        ...
        <SafeAreaView className="flex-1 bg-white">
            <View className="flex-1 px-6 pt-10">
                ...
                <View className="mt-6 items-center">
                    ...
                    >
                        <Text
                            className={`font-visby-medium text-base ${resendCountdown > 0 ? 'text-gray-400' : 'text-primary'
                                }`}
                        >
                ...
                <TouchableOpacity
                    onPress={() => router.back()}
                    className="mt-auto items-center pb-6"
                >
                    <Text className="font-visby text-sm text-gray-500">
                        Wrong email?{' '}
                        <Text className="font-visby-medium text-primary">Go back</Text>
                    </Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
